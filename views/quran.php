...
<body>
<header class="quran-nav"><div class="quran-wrap"><a href="index.php?page=home">← Beranda</a><b>Baca Al-Qur’an</b><a href="index.php?page=login">Masuk</a></div></header>
<main class="quran-wrap quran-main">
    ...
    <a class="last-reading" id="lastReading" hidden><small>Terakhir Dibaca</small><b id="lastReadingName"></b><span id="lastReadingVerse"></span><i>Lanjutkan →</i></a>
    ...
    <section class="surah-grid" id="surahGrid">
        <?php foreach($publicSurahs as $surah):?><a class="surah-card" href="index.php?page=quran-read&surah=<?=(int)$surah['surah_number']?>" data-name="<?=e(strtolower($surah['name']))?>" data-number="<?=(int)$surah['surah_number']?>" data-juz="<?=(int)$surah['juz']?>"><span class="surah-no"><?=(int)$surah['surah_number']?></span><div><b><?=e($surah['name'])?></b><small><?=(int)$surah['verses']?> ayat</small></div><em>Juz <?=(int)$surah['juz']?></em><i>→</i></a><?php endforeach?>
    </section>
    <div class="quran-empty" id="quranEmpty" hidden>Surat yang dicari tidak ditemukan.</div>
</main>
<script src="assets/quran.js?v=20260811b"></script>
</body></html>
